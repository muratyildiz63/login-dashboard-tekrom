                    ...
                    <form>
                      ...
                      <div class="text-center pt-1 mb-12 pb-1">
                        <button
                          ...
                          data-mdb-ripple-color="light" @click="login"
                        >
                         Giriş  Yap
                        </button>
...
export default {
  ...
  methods: {
     ...
     login(){
     const key="tsoft123"
     const cryPassword= CryptoJs.AES.HmacSHA1(this.UserPassword ,key).toString() 
     console.log(cryPassword)

      axios.get(`http://localhost:3000/user?username=${this.userName}&password=${cryPassword}`).then((res)=>{
