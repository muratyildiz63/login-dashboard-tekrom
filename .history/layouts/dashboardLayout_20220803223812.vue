<template>
  <div v-show="inlogin">
    ...
    <div class="flex flex-nowrap w-full">
      <div class="w-2/12">menu alanı</div>
      <div class="w-10/12"><Nuxt /></div>
    </div>

    <footer class="text-center lg:text-left bg-gray-100 text-gray-600 fixed bottom-0 left-0 right-0">
      <div
        class="
          flex
          justify-center
